...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("------SPACE SHOOTING------",canvas.width/2-300,canvas.height/2-300);
    text("ENJOY THE GAME!",canvas.width/2-300,canvas.height/2+100);
    stroke("white");
    fill("black");
    textSize(30);
    textFont("Apple Chancery");
    text("Year 2100 ...",canvas.width/2-300,canvas.height/2-250);
    text(" Some Asteroids are coming towords our Planet.",canvas.width/2-300, canvas.height/2 - 210);
